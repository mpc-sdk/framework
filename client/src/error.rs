...
pub enum Error {
    ...
    /// FROST library error.
    #[error(transparent)]
    FrostEd25519Core(#[from] mpc_driver::frost_ed25519::Error),

    #[cfg(feature = "cggmp")]
    /// CGGMP library error.
    #[error(transparent)]
    Cggmp(#[from] mpc_driver::cggmp::Error),

    #[cfg(feature = "frost-ed25519")]
    /// FROST library error.
    #[error(transparent)]
    FrostEd25519(#[from] mpc_driver::frost::Error),
}
